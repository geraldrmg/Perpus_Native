...
.overlay {
  background-image: url("./assets/image3.gif");
...
.custom-select select {
  ...
  border-radius: 5px;
  background-color: #eee;
  appearance: none; /* Untuk menghilangkan default arrow di browser */
  -webkit-appearance: none;
  -moz-appearance: none;
}

.custom-select select::-ms-expand {
  display: none; /* Menghilangkan default arrow di Internet Explorer */
}

.custom-select::after {
  content: '\25BC'; /* Menambahkan custom arrow */
  position: absolute;
  top: 50%;
  right: 15px;
...
/* Style saat select dihover */
.custom-select:hover::after {
  color: #4CAF50;
}

/* Style saat select focus */
  ...
  <select name="id_kelas" class="form-control">
    ...
    <div class="form-container login-container">
        <form action="proses_login.php" method="post">
            ...
            <input type="pasword" name="password" placeholder="Password" class="form-control">
